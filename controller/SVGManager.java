 ...
 * @version 1.0
 * Semesterprojekt Pattern und Frameworks Winter 2022/2023
 */
public class SVGManager {

    /**
     * Variablendeklaration für die Singleton SVGManager Instanz.
     */
    private static final SVGManager instance = new SVGManager();
    /**
     * Variablendeklaration für die Gruppe der SVG-Pfade.
     */
    public static final Group svgGroup = new Group();
    /**
     * Variablendeklaration für die Liste der SVG-Strings.
     */
    public static ObservableList<String> svgStringList;


    /**
     * Variablendeklaration für die statischen Set-Farben.
     */
    ...
    /**
     * SET 1
     * Variablendeklaration für die SVG-String-Pfade.
     */
    ...
    public static final String HANDLEBAR2 = "M512.3,219.3l-17.1-29.6c0,0-2.1-8,7.6-9.3c9.7-1.2,61.9,0.3,61.9,0.3s19.9,1.5,23.1,20.6c3.2,19.3-24.2,25.5-35.2,25.1c-11.1-0.7-11.5-14,0-14.3s17.6,0.7,19.3-8.4c1.5-9.1-9.7-8.4-9.7-8.4h-46l13.6,24l0,0.6l-17.4-0.2L512.3,219.3z";
    //"M512.4,219.5l-17.2-29.8c0,0-2.1-8,7.6-9.3c9.7-1.2,61.9,0.3,61.9,0.3s19.9,1.5,23.1,20.6c3.2,19.3-24.2,25.5-35.2,25.1c-11.1-0.7-11.5-14,0-14.3s17.6,0.7,19.3-8.4c1.5-9.1-9.7-8.4-9.7-8.4h-46l13.4,24.4L512.4,219.5z";
    ...
    public static final String HANDLEBAR3 = "M514.3,172.8c0,0,11.9-19.7,11.8-20.4s-23.5-25.9-23.5-25.9h-50l-0.7,14.7h43.9c0,0,7.2,12.7,7.2,13.2c0,0.4-8.4,15.7-8.4,15.7l17.8,49.2l0.3,0.6h16.8l0.3-0.6L514.3,172.8z";
    //"M514.2,172.8c0,0,12-19.7,11.9-20.4s-23.5-25.9-23.5-25.9h-50l-0.7,14.7h43.9c0,0,7.2,12.7,7.2,13.2c0,0.4-8.4,15.7-8.4,15.7l17.9,49.4h17.3L514.2,172.8z";

    /**
     * Standard-Konstruktor der Klasse
     * SVG-String Liste wird mit Initialwerten gefüllt.
     */
    public SVGManager() {
    ...
    /**
     * Die Gruppe für die SVG-Pfade wird gesäubert und die neuen SVG-Pfade werden hinzugefügt.
     */
    ...
    /**
     * Gibt das SVG-Objekt anhand des gewählten SVG-Strings und Hex-Color-Strings zurück.
     * @param pathString SVG-String
     * @param colorString SVG-Hex-Color-String
     * @return SVG-Objekt
     */
    ...
    /**
     * Setzt den gewünschten SVG-String des Rahmens und aktualisiert die SVG-String Liste.
     * @param frameString SVG-String
     */
    ...
    /**
     * Setzt die gewünschte SVG-String-Farbe des Rahmens und aktualisiert die SVG-String Liste.
     * @param frameColor SVG-Farben-String
     */
    ...
    /**
     * Setzt den gewünschten SVG-String des Sattels und aktualisiert die SVG-String Liste.
     * @param seatString SVG-String
     */
    ...
    /**
     * Setzt die gewünschte SVG-String-Farbe des Sattels und aktualisiert die SVG-String Liste.
     * @param seatColor SVG-Farben-String
     */
    ...
    /**
     * Setzt den gewünschten SVG-String des Rades und aktualisiert die SVG-String Liste.
     * @param tireString SVG-String
     */
    ...
    /**
     * Setzt die gewünschte SVG-String-Farbe des Rades und aktualisiert die SVG-String Liste.
     * @param tireColor SVG-Farben-String
     */
    ...
    /**
     * Setzt den gewünschten SVG-String des Lenkers und aktualisiert die SVG-String Liste.
     * @param hbString SVG-String
     */
    ...
    /**
     * Setzt die gewünschte SVG-String-Farbe des Lenkers und aktualisiert die SVG-String Liste.
     * @param hbColor SVG-Farben-String
     */
    ...
    /**
     * Gibt den gewünschten SVG-String der SVG-String Liste anhand der gesetzten Integer Position zurück.
     * @param pos Position in der SVG-String Liste
     * @return SVG-String
     */
